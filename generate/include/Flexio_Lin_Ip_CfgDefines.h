...
#ifndef FLEXIO_0_PIN_8_USED
    #define FLEXIO_0_PIN_8_USED
#else
    #error "PIN_8 cannot be used by LIN driver. Pin used by another driver!"
#endif
...
#else
    #error "PIN_2 cannot be used by LIN driver. Pin used by another driver!"
#endif
