...
- pin_list:
  - {pin_num: '13', peripheral: SIUL2, signal: 'gpio, 132', pin_signal: PTE4, identifier: USER_LED_RED_FS26_VPRE, direction: OUTPUT}
  - {pin_num: '9', peripheral: LPSPI2, signal: lpspi2_pcs0, pin_signal: PTE11, direction: OUTPUT}
  ...
  - {pin_num: '74', peripheral: LPSPI2, signal: lpspi2_sout, pin_signal: PTB3, direction: OUTPUT}
  - {pin_num: '92', peripheral: SIUL2, signal: 'gpio, 74', pin_signal: PTC10, direction: OUTPUT}
  - {pin_num: '42', peripheral: SIUL2, signal: 'gpio, 50', pin_signal: PTB18, identifier: USER_LED_RED_FS26_SJA1110_V33, direction: OUTPUT}
  - {pin_num: '43', peripheral: SIUL2, signal: 'gpio, 51', pin_signal: PTB19, direction: OUTPUT}
